...
public class AziendaReport {
    ...
    private String summaryLastReport;
    ...
    public String getSummaryLastReport() {
        return summaryLastReport;
    }

    public void setSummaryLastReport(String summaryLastReport) {
        this.summaryLastReport = summaryLastReport;
    }
}